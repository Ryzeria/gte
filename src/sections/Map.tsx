...
const Map = () => {
  const [selectedStation, setSelectedStation] = useState<Station | null>(null); // Explicit type
      ...
      <div className="container relative">
        ...
        >
          ...
          <div
            ...
            style={{
              width: "200px",
              zIndex: 1000, // Ensure dropdown is above map
            }}
          >
            <select
          ...
          <div className="w-full h-[600px]">
            <MapContainer
              center={[0, 120]} // Centered on Indonesia
              zoom={5} // Zoom out for full Indonesia view
